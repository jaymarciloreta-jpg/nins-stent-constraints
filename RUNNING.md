...
**Version 0.1.0. Validated on one side of one scan, with synthetic seeds placed by script, not by a clinician.** That is exactly what this round is for: run it on real scans with real seeds and tell me where it breaks. Do not put these numbers in a deck yet.
